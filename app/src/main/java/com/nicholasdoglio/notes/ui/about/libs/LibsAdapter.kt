...
class LibsAdapter(val context: Context) : RecyclerView.Adapter<LibsAdapter.LibsViewHolder>() {
    ...
    private fun populateList() {
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.android_support),
                context.resources.getString(R.string.support_components_license)
            )
        )
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.android_architecture_components),
                context.resources.getString(R.string.support_components_license)
            )
        )
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.rxjava),
                context.resources.getString(R.string.rxjava_android_license)
            )
        )
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.rxandroid),
                context.resources.getString(R.string.rxjava_android_license)
            )
        )
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.rxbinding),
                context.resources.getString(R.string.rxbinding_license)
            )
        )
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.autodispose),
                context.resources.getString(R.string.autodispose_license)
            )
        )
        libraries.add(
            LibsItem(
                context.resources.getString(R.string.dagger),
                context.resources.getString(R.string.dagger_license)
            )
        )
    }
