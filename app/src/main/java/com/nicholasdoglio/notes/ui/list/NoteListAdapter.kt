...
class NoteListAdapter : PagedListAdapter<Note, NoteListAdapter.NoteListViewHolder>(diffcallback) {
    ...
    class NoteListViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
        ...
        private val titleView = itemView.findViewById<TextView>(R.id.cardListTitle)
        private val contentView = itemView.findViewById<TextView>(R.id.cardListDescription)
        var note: Note? = null
